...
from enc_decode import Encoder, Decoder
...
class PositionWiseFFN(nn.Module):
    """
    FFN(Xi) = W2.activation(W1Xi + b1) + b2
    where W1 in R^(d_ff x d),
    W2 in R^(d x d_ff)
    """
...
class TransformerEncoderBlock(nn.Module):
    ...
    multi_head_attn -> add_norm -> postition_wise_ffn -> add_norm
    """
...
class TransformerEncoder(Encoder):
    ...
    def forward(self, X, valid_lens):
        """
        num_blks * transformer_encoder_block
...
class TransformerDecoderBlock(nn.Module):
    ...
    decoder_self_attn -> add_norm -> encoder_decoder_attn -> add_norm -> position_wise_ffn
    """
    def __init__(self, num_hiddens, ffn_num_hiddens, num_heads, dropout, i):
        ...
        self.num_hiddens = num_hiddens
        self.dropout = nn.Dropout(dropout)
        self.i = i # i-th decoder block in the transfomer
...
class TransformerDecoder(nn.Module): # change from original AttentionDecoder
